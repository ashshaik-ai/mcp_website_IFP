...
test.describe("lessons", () => {
  test("quiz marks a correct answer", async ({ page }) => {
    ...
    /* A group of answer buttons, one of which becomes pressed. It was declared
       a radiogroup once, which promises roving focus and arrow-key selection —
       neither was implemented, and arrow-selection would mark every option you
       passed as a wrong answer. */
