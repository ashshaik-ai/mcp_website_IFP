...
/* ── COMPANIONS ── */
const eraLabel: Record<string, { te: string; en: string }> = {
  Makkah: { te: "మక్కా", en: "Makkah" },
  Madinah: { te: "మదీనా", en: "Madinah" },
  Both: { te: "రెండూ", en: "Both" },
};
            ...
            <div className="flex gap-3 min-w-max px-1">
              {stages.map((s, i) => (
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-center leading-tight">{s.year[lang]}</span>
                </button>
              ))}
            </div>
          </div>
            ...
            <div className="relative overflow-hidden bg-white rounded-2xl border border-[var(--if-gold)]/20 p-8">
              ...
              <div className="flex items-start gap-6 flex-wrap mb-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="text-xs font-bold text-[var(--if-gold-ink)] tracking-wider uppercase">{stages[active].year[lang]}</span>
        ...
        <div className="mx-auto max-w-5xl">
          <BlurFade delay={0.1}>
            <div className="text-center mb-10">
              ...
              <h2 className="font-display text-2xl sm:text-3xl font-bold text-[var(--if-green)] mb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {leadership.map((ls, i) => (
              <BlurFade key={ls.label.en} delay={0.07 * i}>
                <div className="relative overflow-hidden bg-white rounded-2xl border border-[var(--if-gold)]/20 p-5 hover:border-[var(--if-gold)]/50 hover:-translate-y-1 transition-all group flex flex-col h-full">
        ...
        <div className="mx-auto max-w-4xl">
          <BlurFade delay={0.1}>
            <div className="text-center mb-10">
              ...
              <h2 className="font-display text-2xl sm:text-3xl font-bold text-[var(--if-gold-light)] mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {salawat.map((s, i) => (
              <BlurFade key={s.label.en} delay={0.08 * i}>
                <div className="bg-white/5 border border-[var(--if-gold)]/20 rounded-2xl p-5 flex flex-col hover:-translate-y-1 transition-all">
