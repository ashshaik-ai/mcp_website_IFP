  ...
  return (
    <PageShell>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--if-green-mid)] to-[var(--if-green)] text-[var(--if-gold-pale)] py-20 px-4">
        <PortalWallpaper portal="learn-quran" />
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-[1fr_1.4fr] gap-6 items-start">
            ...
            <div className="rounded-2xl border border-[var(--if-gold)]/20 bg-white/5 p-6 space-y-4">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-[var(--if-gold-light)] mb-1.5">
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <BlurFade delay={0.15}>
            <div className="relative overflow-hidden rounded-2xl border border-[var(--if-gold)]/20 bg-[var(--if-gold)]/8 p-7 text-center">
              ...
              <p className="text-xs text-[var(--if-gold-light)] font-semibold mb-7">{todayAyah.ref}</p>
