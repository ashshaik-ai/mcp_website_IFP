...
const levels = [
  {
    num: 1,
    title: { te: "అరబిక్ అక్షరమాల", en: "The Arabic Alphabet" },
    arabic: "الحروف الهجائية",
    desc: { te: "28 అక్షరాలు, వాటి రూపాలు మరియు ఉచ్చారణ", en: "28 letters, their forms and pronunciation" },
    lessons: ["Alphabet Introduction", "Letter Forms", "Connecting Letters", "Writing Practice"],
    available: true,
  },
  {
    num: 2,
    title: { te: "హరకాత్ మరియు స్వరాలు", en: "Harakat and Vowels" },
    arabic: "التشكيل والقراءة",
    desc: { te: "Fatha, Kasra, Damma మరియు పొడిగింపులు", en: "Fatha, Kasra, Damma and extensions" },
    lessons: ["Short Vowels", "Long Vowels", "Tanween", "Reading Practice"],
    available: true,
  },
  {
    num: 3,
    title: { te: "పదజాలం నిర్మాణం", en: "Building Vocabulary" },
    arabic: "المفردات الأساسية",
    desc: { te: "ప్రాథమిక అరబిక్ పదాలు మరియు వాటి అర్థాలు", en: "Essential Arabic words and their meanings" },
    lessons: ["Family Words", "Daily Objects", "Nature Words", "Islamic Vocabulary"],
    available: true,
  },
  {
    num: 4,
    title: { te: "రోజువారీ అరబిక్", en: "Everyday Arabic" },
    arabic: "العربية اليومية",
    desc: { te: "సాధారణ వాక్యాలు మరియు సంభాషణలు", en: "Common phrases and conversations" },
    lessons: ["Greetings", "At the Mosque", "Basic Sentences", "Dialogues"],
    available: false,
  },
  {
    num: 5,
    title: { te: "ఖురానిక్ అరబిక్", en: "Quranic Arabic" },
    arabic: "عربية القرآن",
    desc: { te: "ఖురాన్‌లో తరచుగా వచ్చే పదాలు మరియు నమూనాలు", en: "Frequently occurring Quranic words and patterns" },
    lessons: ["Top 100 Quranic Words", "Quranic Phrases", "Surah Vocabulary", "Root Words"],
    available: false,
  },
  {
    num: 6,
    title: { te: "వ్యాకరణ ప్రాథమికాలు", en: "Grammar Basics" },
    arabic: "قواعد النحو",
    desc: { te: "అరబిక్ వ్యాకరణం పరిచయం — నదమ్ మరియు సర్ఫ్", en: "Introduction to Arabic grammar — Nahw and Sarf" },
    lessons: ["Nouns & Verbs", "Sentence Structure", "Gender in Arabic", "Plurals"],
    available: false,
  },
];

const alphabet = [
  { ar: "ا", name: "Alif", en: "'a'" }, { ar: "ب", name: "Ba", en: "b" },
  { ar: "ت", name: "Ta", en: "t" }, { ar: "ث", name: "Tha", en: "th" },
  { ar: "ج", name: "Jim", en: "j" }, { ar: "ح", name: "Ha", en: "h" },
  { ar: "خ", name: "Kha", en: "kh" }, { ar: "د", name: "Dal", en: "d" },
  { ar: "ذ", name: "Dhal", en: "dh" }, { ar: "ر", name: "Ra", en: "r" },
  { ar: "ز", name: "Zay", en: "z" }, { ar: "س", name: "Sin", en: "s" },
  { ar: "ش", name: "Shin", en: "sh" }, { ar: "ص", name: "Sad", en: "ṣ" },
  { ar: "ض", name: "Dad", en: "ḍ" }, { ar: "ط", name: "Ta", en: "ṭ" },
  { ar: "ظ", name: "Dha", en: "ẓ" }, { ar: "ع", name: "'Ayn", en: "'" },
  { ar: "غ", name: "Ghayn", en: "gh" }, { ar: "ف", name: "Fa", en: "f" },
  { ar: "ق", name: "Qaf", en: "q" }, { ar: "ك", name: "Kaf", en: "k" },
  { ar: "ل", name: "Lam", en: "l" }, { ar: "م", name: "Mim", en: "m" },
  { ar: "ن", name: "Nun", en: "n" }, { ar: "ه", name: "Ha", en: "h" },
  { ar: "و", name: "Waw", en: "w/ū" }, { ar: "ي", name: "Ya", en: "y/ī" },
];
...
function LearnArabicPage() {
  ...
  const wordOfDay = [
    ...
    { ar: "إِخْلَاص", roman: "Ikhlas", en: "Sincerity / Purity of intention", te: "నిజాయితీ / నిష్కలంక ఉద్దేశం" },
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-[var(--if-green)] text-[var(--if-gold-pale)] py-20 px-4">
        <div className="mx-auto max-w-4xl text-center flex flex-col items-center gap-5">
          ...
          <BlurFade delay={0.1}>
            <span className="font-arabic text-4xl text-[var(--if-gold)]/70">تعلُّم العربية</span>
          </BlurFade>
          <BlurFade delay={0.15}>
            ...
            {whyLearn.map((item, i) => (
              <BlurFade key={i} delay={0.08 * i}>
                <div className="relative overflow-hidden bg-white rounded-2xl border border-[var(--if-gold)]/15 p-6 text-center hover:border-[var(--if-gold)]/40 transition-colors group">
                  ...
                  <div className="font-arabic text-2xl text-[var(--if-gold)]/70 mb-4 leading-relaxed">{item.ar}</div>
        ...
        <div className="mx-auto max-w-5xl">
          <BlurFade delay={0.1}>
            <h2 className="font-display text-3xl font-bold text-[var(--if-green)] text-center mb-2">
              {lang === "te" ? "అరబిక్ అక్షరమాల" : "The Arabic Alphabet"}
            </h2>
            <p className="text-center text-[var(--if-text-muted)] mb-10 text-sm">
              {lang === "te" ? "28 అక్షరాలు — ప్రతి అక్షరాన్ని నేర్చుకోండి" : "28 letters — learn each one"}
            </p>
          </BlurFade>
          <div className="grid grid-cols-4 sm:grid-cols-7 gap-3">
            {alphabet.map(({ ar, name, en }) => (
              <BlurFade key={name + en} delay={0.01}>
                <div className="flex flex-col items-center p-3 rounded-xl bg-white border border-[var(--if-gold)]/15 hover:border-[var(--if-gold)]/50 hover:bg-[var(--if-cream-light)] transition-all cursor-default group">
                  <span className="font-arabic text-3xl text-[var(--if-green)] group-hover:text-[var(--if-gold)] transition-colors">{ar}</span>
                  <span className="text-[10px] font-semibold text-[var(--if-text-muted)] mt-1">{name}</span>
                  <span className="text-[10px] text-[var(--if-gold)]/70">{en}</span>
                </div>
              </BlurFade>
            ))}
          </div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="font-arabic text-sm text-[var(--if-gold)]/70">{level.arabic}</span>
                        {!level.available && (
        ...
        <div className="mx-auto max-w-md">
          <BlurFade delay={0.1}>
            ...
            <div className="relative overflow-hidden bg-[var(--if-green)] rounded-2xl p-8 text-center text-[var(--if-gold-pale)]">
              ...
              <div className="font-arabic text-6xl text-[var(--if-gold-light)] mb-3 leading-relaxed">{w.ar}</div>
              ...
              <div className="text-[var(--if-gold-pale)]/60 text-sm">{w.te}</div>
              <div className="flex justify-center gap-4 mt-6">
                ...
                >
                  <ChevronLeft className="h-4 w-4 text-[var(--if-gold-light)]" />
                </button>
                ...
                <button
                  ...
                  className="p-2 rounded-full border border-[var(--if-gold)]/30 hover:bg-white/10 transition-colors"
                >
                  <ChevronRight className="h-4 w-4 text-[var(--if-gold-light)]" />
                </button>
              </div>
            </div>
          </BlurFade>
